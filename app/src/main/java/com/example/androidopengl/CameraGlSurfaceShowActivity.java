...
public class CameraGlSurfaceShowActivity extends Activity implements SurfaceTexture.OnFrameAvailableListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_gl_surface_view_animator).setOnClickListener(this);
        findViewById(R.id.btn_gl_surface_view_switch).setOnClickListener(this);
